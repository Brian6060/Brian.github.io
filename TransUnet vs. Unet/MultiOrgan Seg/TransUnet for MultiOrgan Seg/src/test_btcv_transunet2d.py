...
CKPT_PATH = "/Users/brian/Desktop/VCL318/TransU-Net/TransUnet vs. Unet/TransUnet for MultiOrgan Seg/output/train_output/best.pth"
SAVE_ROOT = "/Users/brian/Desktop/VCL318/TransU-Net/TransUnet vs. Unet/TransUnet for MultiOrgan Seg/output/test_output"
BATCH_SIZE = 8
NUM_WORKERS = 0
INPUT_SIZE = (320, 320)
BASE_CHANNELS = 64
...
def main() -> None:
    ...
    test_loader = build_btcv2d_transunet_dataloader(
        root_dir=data_root,
        mode="test",
